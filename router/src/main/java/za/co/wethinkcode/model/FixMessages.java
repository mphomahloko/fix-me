...
public class FixMessages {
    ...
    // Variables / Fields
    // make all fields strings - makes it easier for string manipulation and calculating the checksum
    //				//FieldName 				// Tag	// Original Type	// How Value is Set
    // Message Header
    private String	_beginString = "FIX.4.0";	// 8	// String			// Is a constant
    private String	_bodyLength;				// 9	// Length - bytes	// Is calculated
    private String	_msgType;					// 35	// String			// Set by constructor
    private String	_senderCompID;				// 49	// String			// Set by constructor
    private String	_targetCompID;				// 56	// String			// Set by constructor
    private String	_msgSeqNum = "1";			// 34	// SeqNum			// Is a constant
    private String	_sendingTime;				// 52	// UTCTimestamp		// Is calculated

    // Message Body
    // Message Body - Shared Fields
    private String	_symbol;					// 55 	// String			// Set by constructor   //Instrument
    private String	_side;						// 54 	// char				// Set by constructor   // 1=buy, 2=sell
    private String	_orderQty;					// 38 	// Qty - float		// Set by constructor
    // Message Body - New Order Single 35 = D
    private String	_clOrdID;					// 11 	// String			// Set by constructor
    private String	_handlInst = "1";			// 21	// char				// Is a constant		// 1 = AutomatedExecutionNoIntervention
    private String	_ordType = "1";				// 40	// char				// Is a constant		// 1 = Market
    // Message Body - Execution Report 35 = 8
    private String	_orderID;					// 37 	// String			// Set by constructor 	// response with _clOrdID (11)
    private String	_execID = "0";				// 17	// String			// Is a constant		// 0 for Order Status
    private String	_execTransType = "3";		// 20	// char 			// Is a constants		// 3 = Status
    private String	_ordStatus;					// 39 	// char				// Set by constructor	// 2 = Filled/Executed , 8 = Rejected
    private String	_cumQty;					// 14 	// Qty - float		// Set by constructor
    private String	_avgPx;						//  6 	// Price  float		// Set by constructor

    // Message Trailer
    private String	_checkSum;					// 10	// String			// Is calculated

//     // Constructors
//        // With New Order Single (35 = D)
//        public FixMessage(){
//        }
//
//        // With Execution Report (35 = 8)
//        public FixMessage(String symbol, String side, String orderQty, String orderID, String ordStatus, String cumQty, String avgPx){
//            this._symbol;
//            this._side;
//            this._orderQty;
//            this._orderID;
//            this._execID = "0";
//            this._execTransType = "3";
//            this._ordStatus;
//            this._cumQty;
//            this._avgPx;
//        }
...
//_________________________________________________________________________________________BREAKDOWN OF FIX-ME_________________________________________________________________________________________
//
